...
async def database_test():
    mongo_database = disnakeSuperUtils.DatabaseManager.connect(
    ...
    postgre_database = disnakeSuperUtils.DatabaseManager.connect(
    ...
    mysql_database = await disnakeSuperUtils.create_mysql(
        host=..., port=..., user=..., password=..., dbname=...
    )
    # Replace '...' with the arguments.
    # create_mysql supports mysql AND mariaDB

    sqlite_database = disnakeSuperUtils.DatabaseManager.connect(
